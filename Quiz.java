...
public class Quiz extends JFrame implements ActionListener{
    ...
    JLabel qno, question;
    String q[][] = new String[10][5]; // 10Quest, har question->5
    String pa[][] = new String[10][1];//10Quest, ans. possible ->1
    String qa[][] = new String[10][2];//correct ans.. 1st location pe ans.
    ...
    Quiz(String username){
       ...
       // setLocation(10,50);
        ...
        // Buttongroup use kiya taaki dusra op select kiya to 1st wala hatt jaaye
        options.add(opt1);
        options.add(opt2);
        options.add(opt3);
        options.add(opt4);
        ...
        next.setBounds(1100, 530, 200, 30);
        add(next);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == next){
            ...
            ans_given = 1; // taaki next frame mei timmer 15 se start ho
            ...
            count++;
            start(count); // taaki updated value jaaye and question change ho.
            ...
            for(int i =0 ; i < pa.length ; i++){
                if(pa[i][0].equals(qa[i][1])){  //qa mei 1st  position pe ans. daale hai
                    score+=10;
                }else{
                    score+=0;
                }
    ...
    public void paint(Graphics g){  //graphic class ka object lega apne argument mei
        super.paint(g);
        ...
        timer--; // 14
        // Need to call paint funct again n again
        //taaki timer ki value kam ho har baar n display
        ...
        if(ans_given == 1){ //clicks next
            ans_given = 0; 
            //taaki 15 pe atka na reh jaate  next frame mei
            timer = 15;
        }else if(timer < 0){ //time up, didnt click next
            timer = 15;
            opt1.setEnabled(true);
            opt2.setEnabled(true);
            opt3.setEnabled(true);
