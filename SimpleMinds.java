...
public class SimpleMinds extends JFrame implements ActionListener{
    ...
    JTextField t1;
    SimpleMinds(){
        setBounds(400, 200, 1200, 500); // dleft, //dup // length, height ///////400, 200, 1200, 500
    ...
    public void actionPerformed(ActionEvent ae){  // ae k jagah koi bhi naam chalega
        if(ae.getSource() == b1){
            String name = t1.getText();
            this.setVisible(false);   //screen or Frame
            new Rules(name);
        }else{
            System.exit(0);
        }
